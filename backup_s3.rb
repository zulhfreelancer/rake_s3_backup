...
emojis         = [':muscle:', ':zap:', ':tada:', ':confetti_ball:', ':dancer:']
...
msg = "S3 backup for the Rails app has been generated successfully and stored in *#{target_folder}* folder. #{emojis.sample}"
